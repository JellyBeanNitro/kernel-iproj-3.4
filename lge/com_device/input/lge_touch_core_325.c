...
extern int LGF_TestModeGetDisableTouchDevice(void);
#endif
...
#ifdef CONFIG_MACH_LGE_325_BOARD_VZW
	if(!LGF_TestModeGetDisableInputDevices() || !LGF_TestModeGetDisableTouchDevice()) {
#endif
	/* Finger handle */
...
#ifdef CONFIG_MACH_LGE_325_BOARD_VZW
				((vs950_need_touch_downlaod) ? "E112" : "S009"), ts->fw_info.fw_upgrade.fw_force_upgrade);
#else				
