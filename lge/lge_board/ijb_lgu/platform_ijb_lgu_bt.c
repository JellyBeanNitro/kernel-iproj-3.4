...
static int ijb_lgu_bluetooth_toggle_radio(void *data, bool state)
{
	...
	int (*power_control)(int enable);
	 ...
	 printk(KERN_ERR "[LG_BTUI] %s : Called ijb_lgu_bluetooth_toggle_radio",__func__);  	 	
...
static struct bluetooth_platform_data ijb_lgu_bluetooth_data = {
	...
	.bluetooth_toggle_radio = ijb_lgu_bluetooth_toggle_radio,
};
...
static struct platform_device msm_bluesleep_device = {
	...
	.dev = {
		.platform_data = &ijb_lgu_bluesleep_data,
	},	
};
